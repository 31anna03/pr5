		...
		void InitializeComponent(void)
		{
			...
			this->toolStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(21) {
				this->ñîçäàòüToolStripButton,
					this->îòêğûòüToolStripButton, this->ñîõğàíèòüToolStripButton, this->ïå÷àòüToolStripButton, this->toolStripSeparator, this->toolStripButton7,
					this->toolStripButton8, this->toolStripSeparator4, this->âûğåçàòüToolStripButton, this->êîïèğîâàòüToolStripButton, this->âñòàâêàToolStripButton,
					this->toolStripSeparator1, this->toolStripButton1, this->toolStripButton2, this->toolStripButton3, this->toolStripSeparator6,
					this->toolStripButton4, this->toolStripButton5, this->toolStripButton6, this->toolStripSeparator2, this->ñïğàâêàToolStripButton
			});
			this->toolStrip1->Location = System::Drawing::Point(0, 28);
			this->toolStrip1->Name = L"toolStrip1";
			this->toolStrip1->Size = System::Drawing::Size(580, 27);
			...
			this->ñîçäàòüToolStripButton->Text = L"Ñòâîğèòè";
			...
			this->îòêğûòüToolStripButton->Text = L"Â³äêğèòè";
			...
			this->ñîõğàíèòüToolStripButton->Text = L"Çáåğåãòè";
			...
			this->ïå÷àòüToolStripButton->Text = L"Äğóê";
			...
			this->toolStripButton7->Text = L"Ñêàñóâàòè";
			...
			this->toolStripButton8->Text = L"Ïîâåğíóòè";
			...
			this->âûğåçàòüToolStripButton->Text = L"Âèğ³çàòè";
			...
			this->êîïèğîâàòüToolStripButton->Text = L"Êîï³şâàòè";
			...
			this->âñòàâêàToolStripButton->Text = L"Âñòàâêà";
			...
			this->toolStripButton1->Text = L"Ïî ë³âîìó";
			...
			this->toolStripButton2->Text = L"Ïî öåíòğó";
			...
			this->toolStripButton3->Text = L"Ïî ïğàâîìó";
			...
			this->ñïğàâêàToolStripButton->Text = L"Äîâ³äêà";
			...
			this->richTextBox1->Location = System::Drawing::Point(0, 72);
			this->richTextBox1->Name = L"richTextBox1";
			this->richTextBox1->Size = System::Drawing::Size(568, 317);
			...
			this->statusStrip1->Location = System::Drawing::Point(0, 392);
			this->statusStrip1->Name = L"statusStrip1";
			this->statusStrip1->Size = System::Drawing::Size(580, 26);
			...
			this->menuStrip1->Size = System::Drawing::Size(580, 28);
			...
			this->Name = L"MyForm";
			this->Text = L"Ïğàêòè÷íà ğîáîòà ¹5";
...
private: System::Void toolStripButton1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	toolStripStatusLabel1->Text = "Âèğşâàííÿ ïî ë³âîìó êğàş";
}
private: System::Void toolStripButton2_Click(System::Object^ sender, System::EventArgs^ e) {
	richTextBox1->SelectionAlignment = HorizontalAlignment::Center;
	toolStripStatusLabel1->Text = "Âèğşâàííÿ ïî öåíòğó";
}
private: System::Void toolStripButton3_Click(System::Object^ sender, System::EventArgs^ e) {
	richTextBox1->SelectionAlignment = HorizontalAlignment::Right;
	toolStripStatusLabel1->Text = "Âèğşâàííÿ ïî ïğàâîìó êğàş";
}
private: System::Void richTextBox1_TextChanged_1(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void toolStripButton4_Click(System::Object^ sender, System::EventArgs^ e) {
	if (richTextBox1->SelectionFont->Bold) richTextBox1->Font = gcnew System::Drawing::Font(richTextBox1->SelectionFont, richTextBox1->SelectionFont->Style & ~FontStyle::Bold);
	else richTextBox1->Font = gcnew System::Drawing::Font(richTextBox1->SelectionFont, richTextBox1->SelectionFont->Style | FontStyle::Bold);
	toolStripStatusLabel1->Text = "Íàï³âæèğíèé";
}
private: System::Void toolStripButton5_Click(System::Object^ sender, System::EventArgs^ e) {
	if (richTextBox1->SelectionFont->Italic) richTextBox1->Font = gcnew System::Drawing::Font(richTextBox1->SelectionFont, richTextBox1->SelectionFont->Style & ~FontStyle::Italic);
	else richTextBox1->Font = gcnew System::Drawing::Font(richTextBox1->SelectionFont, richTextBox1->SelectionFont->Style | FontStyle::Italic);
	toolStripStatusLabel1->Text = "Êóğñèâ";

}
private: System::Void toolStripButton6_Click(System::Object^ sender, System::EventArgs^ e) {
	if (richTextBox1->SelectionFont->Underline) richTextBox1->Font = gcnew System::Drawing::Font(richTextBox1->SelectionFont, richTextBox1->SelectionFont->Style & ~FontStyle::Underline);
	else richTextBox1->Font = gcnew System::Drawing::Font(richTextBox1->SelectionFont, richTextBox1->SelectionFont->Style | FontStyle::Underline);
...
private: System::Void ñïğàâêàToolStripButton_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("Êëèì÷óê Àííà, ñòóäåíòêà 3ÑÎÌ");
...
private: System::Void ïå÷àòüToolStripButton_Click(System::Object^ sender, System::EventArgs^ e) {
	toolStripStatusLabel1->Text = "Äğóêóâàòè";
